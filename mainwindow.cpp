    ...
    ui(new Ui::MainWindow)
{
    ...
    infoWidgetShow->setCheckable(true);infoWidgetShow->setChecked(true);
    opWidgetShow=new QAction(tr("Op"),this);
    opWidgetShow->setCheckable(true);opWidgetShow->setChecked(true);
    messaWidgetShow=new QAction(tr("Message"),this);
    messaWidgetShow->setCheckable(true);messaWidgetShow->setChecked(true);
...
{
    QMessageBox::about(this,"About",tr("yhf")+"\n" + tr("StudentID")+" :21824048\n"+tr("3D-CAD")+"\n" +tr("SACA")+"\n20181025\nplease contact hfye@zju.edu.cn for more infomation");
}
